...
public class food extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position)
            {
                ...
                case 2:return  mojitos.newInstance();
    ...
    public static class mojitos extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
         ...
         * Use this factory method to create a new instance of
         * this fragment using the provided parameters.
         * @return A new instance of fragment mojitos.
         */
        // TODO: Rename and change types and number of parameters
        public static mojitos newInstance() {
            String param1="dffdsvss", param2="svvvvffesssdf";
            mojitos fragment = new mojitos();
            Bundle args = new Bundle();
            args.putString(ARG_PARAM1, param1);
            args.putString(ARG_PARAM2, param2);
            fragment.setArguments(args);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_food, container, false);
            TextView textView=(TextView)rootView.findViewById(R.id.text);
            textView.setText("MOJITOs");
            TextView textView2=(TextView)rootView.findViewById(R.id.arrow_left);
            textView2.setText("<");

            ImageView imageView=(ImageView)rootView.findViewById(R.id.image);
            imageView.setImageResource(R.drawable.mojitos);
